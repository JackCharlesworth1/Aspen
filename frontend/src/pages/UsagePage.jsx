...
const UsagePage=()=>{
    ...
    <div style={{marginLeft:"auto",marginRight:"auto",width:"65%"}}>
        ...
        <img style={{width:"100%"}} src="images/selection_screen.png" />
        ...
        <img style={{width:"100%"}} src="images/info_one.png" />
        ...
        <img style={{width:"100%"}} src="images/info_two.png" />
        ...
        <img style={{width:"100%"}} src="images/info_three.png" />
        ...
        <img style={{width:"100%"}} src="images/account_screen.png" />
