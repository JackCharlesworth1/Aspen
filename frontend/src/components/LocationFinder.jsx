...
function LocationFinder({species}) {
    ...
    const findNearbyLocation=async ()=>{
        ...
        const backend_response=fetch('https://api.theaspenproject.cloud/api/external/getNearbySpeciesLocations',{headers:{"Authorization":access_token,"Content-Type":"application/json"},body:JSON.stringify(origin:origin,species:species)})
